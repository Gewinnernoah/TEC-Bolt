...
export const DEVICE_STATUS_META: Record<DeviceStatus, { label: string; color: string; bg: string; dot: string }> = {
  available: { label: 'Verfuegbar', color: 'text-emerald-300', bg: 'bg-emerald-500/15 border-emerald-500/30', dot: 'bg-emerald-400' },
...
export const LOAN_STATUS_META: Record<LoanStatus, { label: string; color: string; bg: string; dot: string }> = {
  ...
  returned: { label: 'Zurueckgegeben', color: 'text-emerald-300', bg: 'bg-emerald-500/15 border-emerald-500/30', dot: 'bg-emerald-400' },
  overdue: { label: 'Ueberfaellig', color: 'text-red-300', bg: 'bg-red-500/15 border-red-500/30', dot: 'bg-red-400' },
};
...
export const REQUEST_STATUS_META: Record<RequestStatus, { label: string; color: string; bg: string; dot: string }> = {
  ...
  fulfilled: { label: 'Erfuellt', color: 'text-emerald-300', bg: 'bg-emerald-500/15 border-emerald-500/30', dot: 'bg-emerald-400' },
...
export const TICKET_STATUS_META: Record<TicketStatus, { label: string; color: string; bg: string; dot: string }> = {
  ...
  resolved: { label: 'Geloest', color: 'text-emerald-300', bg: 'bg-emerald-500/15 border-emerald-500/30', dot: 'bg-emerald-400' },
  closed: { label: 'Geschlossen', color: 'text-slate-400', bg: 'bg-slate-500/15 border-slate-500/30', dot: 'bg-slate-500' },
  escalated: { label: 'Eskaliert', color: 'text-red-300', bg: 'bg-red-500/15 border-red-500/30', dot: 'bg-red-400' },
};
...
export const PRINT_STATUS_META: Record<PrintStatus, { label: string; color: string; bg: string; dot: string }> = {
  ...
  validating: { label: 'Wird geprueft', color: 'text-blue-300', bg: 'bg-blue-500/15 border-blue-500/30', dot: 'bg-blue-400' },
...
export const CONDITION_META: Record<ConditionRating, { label: string; color: string }> = {
  ...
  damaged: { label: 'Beschaedigt', color: 'text-orange-300' },
...
export const ROLE_META: Record<UserRole, { label: string; color: string; bg: string }> = {
  ...
  staff: { label: 'Ausleih-Personal', color: 'text-blue-300', bg: 'bg-blue-500/15' },
